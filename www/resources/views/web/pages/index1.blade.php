...
@section('main_content')
    ...
    <section class="banner">
        <img class="banner_img" src="{{ asset('web_assets/images/banner11.png') }}" alt="banner">
                ...
                <div class="col-lg-4 col-md-6 game_summary_item">
                    <div class="game_summary_item_inner">
                        ...
                        <div class="text-center inner_text">
                            ...
                            <p>Instead of drafting players and setting a lineup each week, you draft four teams and pick whether
                ...
                <div class="col-lg-4 col-md-6 game_summary_item">
                    <div class="game_summary_item_inner">
                        ...
                        <div class="text-center inner_text">
                            ...
                            <p>Prizes and payouts for each quarter and end of season.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-lg-9 col-md-12 ms-auto">
                        <div class="structure_item mb-3">
                            <p class="structure_heading skew_minus_21">4TEAMFANTASY&copy; IS SET UP AS A MEMBERS ONLY CLUB.</p>

                            <ul class="skew_minus_21">
                                <li>We charge a membership fee to join the club. The Membership Fee is outlined below for each level.</li>
                                <li>The rest of the “In-Play” money goes directly to the player’s prize pool payouts.</li>
                            </ul>
                        </div>

                        <div class="structure_item">
                            <p class="structure_heading skew_minus_21">EACH MEMBER WILL PICK THEIR LEVEL OF PLAY, BASED
                                UPON
                                THEIR BUY-IN
                                AMOUNT </p>
                ...
                <div class="list">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="list_inner_item mb-3">
                                <i class="fa-solid fa-circle m-3"></i>
                                <p class="mb-0 fs-1 fw-bold font_roboto"> ONE SCORE COMPETES WITHIN YOUR GROUP OF 8 AND AGAINST THE ENTIRE LEVEL FOR PRIZES AND PAYOUTS
                                </p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
